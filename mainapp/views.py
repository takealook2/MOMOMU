...
# chromedriver = webdriver.Chrome(executable_path=os.environ.get("CHROMEDRIVER_PATH"), webdriver_options=webdriver_options)
...
# brower = webdriver.Chrome(executable_path=os.environ.get("CHROMEDRIVER_PATH"), chrome_options=chrome_options)
